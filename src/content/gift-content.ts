...
export const giftContent: GiftContent = {
  ...
  garden: [
    ...
    },
    {
      id: "garden-2",
      title: "Ketulusanmu",
      body: "Kamu selalu berusaha hadir dengan hati yang jujur, bahkan saat itu tidak mudah.",
    },
    {
      id: "garden-3",
      title: "Perhatian kecilmu",
      body: "Hal-hal sederhana yang kamu ingat sering terasa lebih berarti dari hadiah besar.",
    },
    {
      id: "garden-4",
      title: "Keberanianmu",
      body: "Kamu tetap melangkah meski kadang harus membawa banyak hal sendirian.",
    },
    {
      id: "garden-5",
      title: "Sisi lembutmu",
      body: "Ada rasa aman dalam caramu peduli pada orang-orang yang kamu sayangi.",
    },
    {
      id: "garden-6",
      title: "Dirimu sendiri",
      body: "Bukan karena harus menjadi siapa-siapa—kamu berharga hanya dengan menjadi dirimu.",
    },
  ],
  constellation: [
    {
